...
def main():
    ...
    ffmpeg_command = f'ffmpeg -y -r {FPS} -i {OUTPUT_DIR}/frame_%04d.png -c:v libx264 -pix_fmt yuv420p -vf \"pad=ceil(iw/2)*2:ceil(ih/2)*2\" {OUTPUT_DIR}/lamp_reflection_animation.mp4'
