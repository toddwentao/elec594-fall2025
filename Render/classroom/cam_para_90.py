...
# Compute intrinsics (same as Mitsuba thin-lens)
...
# Generate 90 poses that match Mitsuba rendering
for i in range(num_frames):
    z = -1.5 + step_z * i
    theta = (i / num_frames) * 0.5 * math.pi + 0.25 * math.pi
...
print("✅ transforms.json written with 90 frames!")